    ...
    return (
      <motion.div className="menu menu--mobile" initial={reducedMotion ? false : { opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.35 }}>
        ...
        <span className="mnav__name t-ui-bold" aria-hidden="true">
          <span className="mnav__name-first">{profile.first}</span>
          <span className="mnav__name-last">{profile.last}</span>
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="menu__corner" aria-hidden="true">
        ...
        <span className="menu__vname t-ui-bold">
          <span className="menu__vname-first">{profile.first}</span>
          <span className="menu__vname-last"> {profile.last}</span>
        </span>
      </div>
